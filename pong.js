...
// include: /tmp/zhengkai/tmpj3o0zgsu.js
...
Module['FS_createPath']("/", "static", true, true);
    ...
    loadPackage({"files": [{"filename": "/static/circle.webp", "start": 0, "end": 8644}], "remote_package_size": 8644});

  })();

// end include: /tmp/zhengkai/tmpj3o0zgsu.js
// include: /tmp/zhengkai/tmppx61x1qf.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/zhengkai/tmppx61x1qf.js
// include: /tmp/zhengkai/tmpsc17kopn.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/zhengkai/tmpsc17kopn.js
...
function assignWasmExports(wasmExports) {
  ...
  assert(wasmExports['SDL_free'], 'missing Wasm export: SDL_free');
  _SDL_free = Module['_SDL_free'] = createExportWrapper('SDL_free', 1);
  assert(wasmExports['SDL_malloc'], 'missing Wasm export: SDL_malloc');
  _SDL_malloc = Module['_SDL_malloc'] = createExportWrapper('SDL_malloc', 1);
  assert(wasmExports['SDL_calloc'], 'missing Wasm export: SDL_calloc');
  _SDL_calloc = Module['_SDL_calloc'] = createExportWrapper('SDL_calloc', 2);
  assert(wasmExports['SDL_realloc'], 'missing Wasm export: SDL_realloc');
  ...
  assert(wasmExports['Emscripten_HandlePointerEnter'], 'missing Wasm export: Emscripten_HandlePointerEnter');
  _Emscripten_HandlePointerEnter = Module['_Emscripten_HandlePointerEnter'] = createExportWrapper('Emscripten_HandlePointerEnter', 2);
  assert(wasmExports['Emscripten_HandlePointerLeave'], 'missing Wasm export: Emscripten_HandlePointerLeave');
  _Emscripten_HandlePointerLeave = Module['_Emscripten_HandlePointerLeave'] = createExportWrapper('Emscripten_HandlePointerLeave', 2);
  assert(wasmExports['Emscripten_HandlePointerGeneric'], 'missing Wasm export: Emscripten_HandlePointerGeneric');
  ...
  assert(wasmExports['Emscripten_SendDragEvent'], 'missing Wasm export: Emscripten_SendDragEvent');
  _Emscripten_SendDragEvent = Module['_Emscripten_SendDragEvent'] = createExportWrapper('Emscripten_SendDragEvent', 2);
  assert(wasmExports['Emscripten_SendDragCompleteEvent'], 'missing Wasm export: Emscripten_SendDragCompleteEvent');
  ...
  assert(wasmExports['Emscripten_SendDragTextEvent'], 'missing Wasm export: Emscripten_SendDragTextEvent');
  _Emscripten_SendDragTextEvent = Module['_Emscripten_SendDragTextEvent'] = createExportWrapper('Emscripten_SendDragTextEvent', 2);
  assert(wasmExports['Emscripten_SendDragFileEvent'], 'missing Wasm export: Emscripten_SendDragFileEvent');
  _Emscripten_SendDragFileEvent = Module['_Emscripten_SendDragFileEvent'] = createExportWrapper('Emscripten_SendDragFileEvent', 2);
  assert(wasmExports['Emscripten_SendSystemThemeChangedEvent'], 'missing Wasm export: Emscripten_SendSystemThemeChangedEvent');
  ...
  assert(wasmExports['requestFullscreenThroughSDL'], 'missing Wasm export: requestFullscreenThroughSDL');
